...
const Chat = () => {
  return (
    <div className="flex flex-col flex-1 h-[90vh] lg:h-[97vh] relative overflow-hidden">
      {/* Background effects */}
      ...
      <div className="relative z-10 flex flex-col h-full rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
      <MessageContainer />
    </div>
    </div>
  );
